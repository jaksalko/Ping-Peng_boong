...
public class SimulatorCameraController : MonoBehaviour
{
    ...
    void Start()
    {
        //target = Simulator.instance.nowPlayer;
        camera_transform = main_camera.transform;
        centerOfMap = Simulator.instance.simulatingMap.centerOfMap;
    ...
    void PlayerMove()
    {
        if(Simulator.instance.nowPlayer != null)
        {
            camera_target = Simulator.instance.nowPlayer.transform;
    ...
    void StartLevel()
    {
        ...
        if (coroutine == null)
        {
            camera_target = Simulator.instance.simulatingMap.transform;
    ...
    void MiniMapCamera()
    {
        camera_target = Simulator.instance.simulatingMap.minimapTarget;
