...
namespace AWSSDK.Examples
{
    ...
    {
        public string IdentityPoolId = PrivateData.identitiy_pool_id;
        public string CognitoPoolRegion = RegionEndpoint.APNortheast2.SystemName;
        public string DynamoRegion = RegionEndpoint.APNortheast2.SystemName;
